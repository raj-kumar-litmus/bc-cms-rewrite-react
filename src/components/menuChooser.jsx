...
console.log("memberGroups1>>",memberGroups)
  console.log("memberGroups>>", memberGroups.filter((item)=> item == "Sizing app"))

  return (
    <div className="text-center h-screen bg-bg">
      <h1 className="text-xs font-bold leading-tight tracking-tight text-gray-900 md:text-xs dark:text-white pt-10">Choose the Application</h1>
