       ...
       <div className='bg-bg h-screen bg-bg'>
        ...
        <div className="mt-4 text-center">
          ...
          <div className='m-10 mt-2'>
            ...
            <div className='mt-6'>
            <div class="bg-danger-aler-bg border border-red text-red-700 px-4 py-3 rounded relative" role="alert">
              <span class="text-sm">Style DGET233 and FWPT1Y3 are doesn’t exist</span>
              <button>
